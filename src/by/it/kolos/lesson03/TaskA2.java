...
class TaskA2 {
    public static void main(String[] args) {
        String a = "Ласточка примчалась";
        String b = "Из-за синя моря,";
        String c = "Села и запела:";
        String d = "Как февраль ни злися,";
        String e = "Как ты, март, ни хмурься,";
        String g = "Будь хоть снег, хоть дождик -";
        String j = "Все весною пахнет!";
