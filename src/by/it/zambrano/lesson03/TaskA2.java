...
class TaskA2 {
    public static void main(String[] args) {
        String a="Я знак бессмертия себе воздвигнул";
        String b ="Превыше пирамид и крепче меди,";
        String c ="Что бурный аквилон сотреть не может,";
        String d ="Ни множество веков, ни едка древность.";
