...
class TaskA2 {
    public static void main(String[] args) {
        String a="Though my eyes could see I still was a blind man";
        String b="Though my mind could think I still was a mad man";
        String c="I hear the voices when I'm dreaming,";
        String d="I can hear them say";
